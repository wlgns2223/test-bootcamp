...
describe("RTL 상태 변화 테스트 - Counter 컴포넌트 (실습)", () => {
  ...
  it("초기값이 올바르게 표시된다", () => {
    ...
    // TODO: getByText를 사용해서 "0" 텍스트를 찾으세요
  ...
  it("사용자 정의 초기값이 올바르게 표시된다", () => {
    ...
    // TODO: getByText를 사용해서 "10" 텍스트를 찾으세요
    // TODO: 값이 '10'인지 확인하세요
  });
  ...
  it("증가 버튼이 카운터를 올바르게 증가시킨다", async () => {
    ...
    // TODO: Counter 컴포넌트를 렌더링하세요
    // TODO: getByText로 "0" 텍스트와 getByRole로 "+" 버튼을 찾으세요
  ...
  it("감소 버튼이 카운터를 올바르게 감소시킨다", async () => {
    ...
    // TODO: getByText로 "5" 텍스트와 getByRole로 "-" 버튼을 찾으세요
  ...
  it("리셋 버튼이 카운터를 초기값으로 되돌린다", async () => {
    ...
    // TODO: getByText로 "3" 텍스트와 getByRole로 "+", "Reset" 버튼을 찾으세요
 ...
 *
 * 🎯 요소 찾기:
 * - 카운터 값: getByText("숫자") - 현재 카운터 값을 표시하는 텍스트
 * - 증가 버튼: getByRole("button", { name: "+" }) - "+" 텍스트가 있는 버튼
 * - 감소 버튼: getByRole("button", { name: "-" }) - "-" 텍스트가 있는 버튼
 * - 리셋 버튼: getByRole("button", { name: /reset/i }) - "Reset" 텍스트가 있는 버튼
 *
 * 🔍 주요 쿼리:
