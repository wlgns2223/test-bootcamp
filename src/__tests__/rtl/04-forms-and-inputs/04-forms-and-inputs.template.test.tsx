...
describe("RTL 폼 테스트 - UserForm 컴포넌트 (실습)", () => {
  ...
  it("폼이 올바른 초기 상태로 렌더링된다", () => {
    ...
    // TODO: getByTestId를 사용해서 name-input과 email-input의 초기값이 비어있는지 확인하세요
    // TODO: submit-button이 비활성화되어 있는지 확인하세요
  });

  // 🎯 실습 2: 텍스트 입력 테스트
  it("사용자가 이름을 입력할 수 있다", async () => {
    // TODO: userEvent를 설정하고 UserForm을 렌더링하세요
    // TODO: name-input을 찾으세요
  ...
  it("사용자가 이메일을 입력할 수 있다", async () => {
    ...
    // TODO: email-input을 찾고 "john@example.com"을 입력하세요
  ...
  it("이름만 입력했을 때 제출 버튼이 여전히 비활성화되어 있다", async () => {
    ...
    // TODO: name-input과 submit-button을 찾으세요
  ...
  it("폼 제출 후 성공 메시지가 표시된다", async () => {
    ...
    // TODO: 폼이 더 이상 보이지 않는지 확인하세요 (queryByTestId 사용)
  });
});
 ...
 * - screen.queryByTestId() - 요소 존재 여부 확인
 *
 * 🧪 Mock 함수:
